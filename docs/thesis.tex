...
\definecolor{Cover}{RGB}{255,255,255}    % white cover
...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{L{2.8cm}L{2.2cm}L{1.6cm}L{1.4cm}L{2cm}L{2.5cm}}
    ...
    \midrule
    Auction type & English & Fixed & Олон & Live video & English+BuyNow \\
...
Өчүүхэн жижиг schema-тай боловч хамгийн өндөр write авдаг. Индекс: \texttt{\{ product: 1, price: -1, createdAt: -1 \}} — bid history-ийг үнээр буурах эрэмбээр шуурхай авах боломж.
